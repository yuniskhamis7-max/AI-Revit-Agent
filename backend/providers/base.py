...
SYSTEM_PROMPT = (
    ...
    "If different levels have different boundary extents, you MUST ask the user which level's extents the grids should fit before creating or modifying them. "
